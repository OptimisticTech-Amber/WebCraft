  ...
  const onChangePermission = async (
    ...
    if (response) {
      ...
      if (subAccountPermission) {
        subAccountPermission.Permissions.find((perm) => {
    ...
    <div>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Add or update user details</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex-1">
                    ...
                    <FormControl>
                      <Input {...field} placeholder="Enter email" required />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                  ...
                  <FormItem className="flex-1">
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        <SelectContent>
                          {/* Only one child inside SelectContent */}
              ...
              {authUserData?.role === "AGENCY_OWNER" && (
                <div className="flex flex-col gap-4">
                  ...
                  <FormDescription className="mb-4">
                    {" "}
                    You can give Account access to team member by turning on
