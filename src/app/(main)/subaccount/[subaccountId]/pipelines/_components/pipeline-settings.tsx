...
const PipelineSettings = ({ pipelineId,subaccountId,pipelines,}:{ pipelineId:string,subaccountId:string,pipelines:Pipeline[] }) => {
                ...
                <AlertDialogFooter className='items-center '>
                      ...
                      <AlertDialogAction onClick={async()=>{
                        try{
                            ...
                            toast({
                                title:'Deleted',
                                description:'Your pipeline has been deleted successfully',
                            })
